"""CLI 前端：python -m nyalume.frontends.cli（或仓库根 python cli.py）"""

from nyalume.core import agent, memory, personas, reminders
...
def main() -> None:
    ...
    scheduler.start()
    print(
        "Nyalume 已启动。输入 /new 开新会话，/reminders 看定时提醒，/exit 退出。"
    )
