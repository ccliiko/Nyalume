...
运行后会写入 user_pets/cliko/art/moods/<key>_workflow_api.json（gitignore）；
之后用 tools/cliko_pipeline/comfy_submit.py 逐个排队。
...
REPO_ROOT = ROOT.parents[1]  # tools/cliko_pipeline -> tools -> 仓库根
BASE = ROOT / "workflows" / "q_BA_workflow_api.json"
OUT = REPO_ROOT / "user_pets" / "cliko" / "art" / "moods"
